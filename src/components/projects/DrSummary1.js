    ...
    <div className="row">
      <div className="col s12 m6">
        <div className="card-panel teal">
          ...
          {project4.visitday[2]? <span>,{project4.visitday[1]}</span> :null  }
          {project4.visitday[3]? <span>,{project4.visitday[1]}</span> :null  }
          {project4.visitday[4]? <span>,{project4.visitday[1]}</span> :null  }
          {project4.visitday[5]? <span>,{project4.visitday[1]}</span> :null  }
          {project4.visitday[6]? <span>,{project4.visitday[1]}</span> :null  }
          </div>
        </div>
      </div>
    </div>
